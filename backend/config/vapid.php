<?php
// ============================================
// ClearWay Bénin - Clés VAPID
// Générées une seule fois avec WebPush::genererClesVapid()
// Ne JAMAIS régénérer sans re-souscrire tous les utilisateurs (les clés
// identifient ton serveur auprès des services de notification push)
// ============================================
